  ...
  return [
    {
      ...
      rows: [
        { sr: 1, packName: 'Kanger1.0', openingStock: 5880, receiveQty: 0, totalAvailable: 5880, dispatchQty: 0, closingStock: 5880, maintainedBy: 'Jitendra Soni' },
        { sr: 2, packName: 'Limber', openingStock: 0, receiveQty: 0, totalAvailable: 0, dispatchQty: 0, closingStock: 0, maintainedBy: 'Jitendra Soni' },
        { sr: 3, packName: 'Kanger2.0', openingStock: 522, receiveQty: 0, totalAvailable: 522, dispatchQty: 0, closingStock: 522, maintainedBy: 'Jitendra Soni' },
        { sr: 4, packName: 'Tamor', openingStock: 23, receiveQty: 0, totalAvailable: 23, dispatchQty: 0, closingStock: 23, maintainedBy: 'Jitendra Soni' },
        { sr: 5, packName: 'Nova', openingStock: 5, receiveQty: 0, totalAvailable: 5, dispatchQty: 0, closingStock: 5, maintainedBy: 'Jitendra Soni' },
        { sr: 6, packName: 'Challenger', openingStock: 156, receiveQty: 0, totalAvailable: 156, dispatchQty: 0, closingStock: 156, maintainedBy: 'Jitendra Soni' },
      ...
      totalOpeningStock: 6619, // Excludes Module (534)
      totalReceivedToday: 0,
      totalDispatchToday: 0,
      totalClosingStock: 6619, // Excludes Module (534)
